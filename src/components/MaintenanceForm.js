...
const MaintenanceForm = () => {
    ...
    const handleAddPart = () => {
        ...
        const partCost = parseFloat(newPart.cost);
        ...
        const totalCost = updatedParts.reduce((sum, part) => sum + part.cost, 0);
                ...
                {formData.parts.length > 0 && (
                    <div className="parts-list">
                        ...
                        <div className="total-cost">
                            <strong>Total Cost: ${formData.totalCost.toFixed(2)}</strong>
                        </div>
                    </div>
                )}
